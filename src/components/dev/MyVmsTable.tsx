...
const SkeletonRow = () => (
  <TableRow>
    {columns.map((header, i) => (
      <TableCell key={header || `col-${i}`} sx={{ borderColor: "divider" }}>
...
const MyVmsTable = ({ vms, vmsLoading, vmsError }: Props) => (
